...
public class Principal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        dar_color = new javax.swing.JMenuItem();
        ...
        fonts_ventana = new javax.swing.JDialog();
        ...
        jMenuItem6.setText("Abrir Archivo Binario ");
        ...
        dar_color.setText("Dar color");
        dar_color.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                dar_colorActionPerformed(evt);
            }
        });
        Opciones.add(dar_color);
        ...
        fonts_ventanaLayout.setHorizontalGroup(
...
//			Cambios_de_panel.repaint();
    ...
    private void jButton5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton5MouseClicked
		...
		arregloLabel.add(datos);
		System.out.println(arregloLabel.add(datos));
    ...
    private void jButton6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton6MouseClicked
		...
		documentos1++;
		Panel_De_Diagramas.add(datos);
		datos.setName("documentos" + documentos1);
		datos.setHorizontalTextPosition(SwingConstants.CENTER);
		datos.setLocation(100, 100);
    ...
    private void jButton9MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton9MouseClicked
		...
		DatosProcesos.setName("proceso" + pronum);
		...
		System.out.println(arregloLabel.add(DatosProcesos));
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
		...
		for (JLabel label : arregloLabel) {
			System.out.println(arregloLabel.indexOf(label));
			...
			if (label.getName().contains("proceso") && ((label.getName().contains("+")) || (label.getName().contains("-")) || (label.getName().contains("/")) || (label.getName().contains("*")))) {
				try {
			...
			if (label.getName().contains("proceso") && !label.getName().contains("\"") && label.getText().contains("imprimir")) {
				try {
					fw = new FileWriter(archivo, true);
					bw = new BufferedWriter(fw);
			...
			if (label.getName().contains("proceso") && label.getName().contains("entero")) {
				try {
					fw = new FileWriter(archivo, true);
					bw = new BufferedWriter(fw);
			...
			if (label.getName().contains("proceso") && label.getName().contains("real")) {
				try {
					fw = new FileWriter(archivo, true);
					bw = new BufferedWriter(fw);
...
//		Diagramas_Flujo_ventana.setVisible(true);
    ...
    private void fontsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_fontsActionPerformed
		fonts_ventana.setModal(true);
		fonts_ventana.pack();
		fonts_ventana.setVisible(true);
		fonts_ventana.setLocationRelativeTo(Diagramas_Flujo_ventana);
    }//GEN-LAST:event_fontsActionPerformed

    private void jButton17MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton17MouseClicked
		// TODO add your handling code here:
		int i = 0;
		while (arregloLabel.size() > i) {
			try {
				System.out.println(arregloLabel.get(i));
				i++;
			} catch (Exception e) {
    ...
    private void dar_colorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_dar_colorActionPerformed
		// TODO add your handling code here:
		color = JColorChooser.showDialog(Diagramas_Flujo_ventana, "Eliga un color", color);
		global.setForeground(color);
    }//GEN-LAST:event_dar_colorActionPerformed
    ...
    private void jMenuItem6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem6ActionPerformed
		...
		if (opcion == JFileChooser.APPROVE_OPTION) {
			...
			adc.cargarArchivo();
			for (final JLabel f : adc.getListaLabels()) {
				arregloLabel.add(f);
				Panel_De_Diagramas.add(f);

				f.addMouseMotionListener(new java.awt.event.MouseMotionAdapter() {
					public void mouseDragged(java.awt.event.MouseEvent evt) {
						seleccionado = f;
						f.setLocation(f.getLocation().x + evt.getX() - f.getWidth() / 2,
								f.getLocation().y + evt.getY() - f.getHeight() / 2);
					}
				});
		...
		JOptionPane.showMessageDialog(Diagramas_Flujo_ventana, "Se cargo correctamente");
	...
	JLabel global = null;
	String ruta;
	ArrayList<JLabel> arregloLabel = new ArrayList<JLabel>();
	int Inicio_o_Fin = 0;
	int pronum = 0;
	JLabel seleccionado;
	int datos1 = 0;
